 ...
 * The header for Real Estate Landing Page
...
<head>
  ...
  <link rel="stylesheet" href="/wp-content/themes/twentytwenty/landing-page-folder/landing.css" crossorigin="anonymous"><!-- Make sure this path is correct IT WILL CHANGE -->
...
<header id="plain-header" class="header-background container-fluid">
            ...
            <div class="row" style="    max-width: 1140px; width: 100%; float: none; margin: auto;">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <a class="logo-link" href="[MAIN-URL]" alt="Flat Fee Team website">
